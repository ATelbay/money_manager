...
4. If you find issues — fix them, commit with message `fix(review): <description>`, and push
...
- Do NOT run local gradle checks during review; rely on GitHub Actions CI checks
